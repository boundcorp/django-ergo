...
from django_ergo.tools import (
    ToolRegistry, ToolConfig, tool_registry, tool,
    ToolRegistryBase, UserToolRegistry, user_tools
)
...
class TestToolRegistryErrorHandling(TestCase):
    ...
    def test_execute_tool_function_not_found(self):
        ...
        self.assertIn("function for 'broken_tool' not found", str(context.exception))
